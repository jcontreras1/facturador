<x-app-layout>
    ...
    <div class="container">
        ...
        <form action="{{ route('lote.store.c') }}" method="POST">
            @csrf
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="date" value="{{date('Y-m-d')}}" id="fecha" class="form-control" required>
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <div class="row" id="serviciosFields" style="display: none;">
                    <div class="col-12 col-md-4">
                        ...
                        <input type="date" value="{{date('Y-m-d')}}" id="fechaInicioServicios" class="form-control" required>
                    </div>
                    <div class="col-12 col-md-4">
                        <label for="fechaFinServicios">Fecha de finalización de servicios</label>
                        <input type="date" value="{{date('Y-m-d')}}" id="fechaFinServicios" class="form-control" required>
                    </div>
                    <div class="col-12 col-md-4">
                        <label for="fechaVencimientoPago">Fecha de vencimiento para el pago</label>
                        <input type="date" value="{{date('Y-m-d')}}" id="fechaVencimientoPago" class="form-control" required>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="number" step="0.01" id="importeTotal" class="form-control" placeholder="Importe a facturar" required>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Tope de Facturación</span>
                            <input type="number" step="0.01" id="topeFacturacionInput" class="form-control" placeholder="Tope de Facturación">
                        </div>
                        <div class="input-group">
                            <span class="input-group-text">Cant. Comprobantes</span>
                            <input type="number" id="cantComprobantes" class="form-control" required disabled readonly>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="input-group">
        ...
        <div class="col-12 float-end">
            <button class="btn btn-lg btn-success">Emitir factura</button>
        </div>
        </div>
